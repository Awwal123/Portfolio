...
import CloseIcon from "../assets/images/CloseIcon.png"; // Add an "X" icon for the close state
    ...
    <nav className="bg-white shadow-lg font-medium md:font-normal text-gray-700 flex items-center justify-between h-16 px-5 md:px-20 dark:bg-gray-900 dark:text-gray-300">
      ...
      >
        <div className="flex flex-col md:flex-row md:gap-5 w-full md:w-auto">
          <p className="py-2 md:py-0 px-4 md:px-0 cursor-pointer">About</p>
          <p className="py-2 md:py-0 px-4 md:px-0 cursor-pointer">Work</p>
          <p className="py-2 md:py-0 px-4 md:px-0 cursor-pointer">
            Testimonials
          </p>
          <p className="py-2 md:py-0 px-4 md:px-0 cursor-pointer">Contact</p>
        </div>
        <div className={`${
          isNavOpen ? "block w-full mt-7 mb-7 md md:hidden" : "hidden"
        }`}>
        ...
        <div className="hidden md:flex gap-4 items-center">
          ...
          />
          <div className="w-32 h-10 flex items-center justify-center font-medium rounded-lg bg-gray-900 text-white dark:bg-white dark:text-gray-900 cursor-pointer">
            Download CV
          </div>
        </div>
        ...
        <div className="block md:hidden gap-4 w-full pl-6 pr-6 items-center">
          ...
          <img
            ...
            alt="Dark mode"
            onClick={toggleTheme}
            className="cursor-pointer hidden dark:block w-8 h-8"
          />
          <img
            src={Sun}
            alt="Light mode"
          ...
          <div className="w-40 h-10 flex items-center justify-center font-medium rounded-lg bg-gray-900 text-white dark:bg-white dark:text-gray-900 cursor-pointer">
            Download CV
          </div>
          </div>
        </div>
