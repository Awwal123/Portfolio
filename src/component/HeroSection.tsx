...
export const Herosection = () => {
  return (
    <div className="h-auto md:h-screen  text-gray-600  flex-col-reverse flex gap-5  px-5 pb-5  md:flex-row  md:justify-between items-center dark:text-gray-400 md:px-20 md:py-20 dark:bg-black overflow-hidden">
