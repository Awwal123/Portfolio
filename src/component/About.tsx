      ...
      {/* <div className="md:h-[100%] h-auto"> */}
        ...
        <div className="flex flex-col gap-5 md:flex-row md:justify-between items-center">
          ...
          <div className="flex flex-col gap-5 w-full md:w-[50%] h-full">
            ...
            <p className="text-lg">
              I enjoy connecting and collaborating with others! Feel free to
              check out my portfolio and reach out if you'd like to work
              together or have any questions. I'm always excited to meet fellow
              developers, entrepreneurs, and innovators.
            </p>
